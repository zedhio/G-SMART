<?php
$ext = pathinfo($referensi['file'],PATHINFO_EXTENSION);
$path = base_url("pengunjung/referensi/".$referensi['file']);
if ($referensi['id_guru']==0) {
    $guru = "Admin";
}else{
    $guru = $buku['nama'];
}
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 text-center">
                <?php echo ambil_isi_pengaturan("home_referensi") ?>
            </div>
        </div>
    </div>
    <div class="container">
                ...
                <div class="box wow text-center">
                    <?php if ($ext=="pdf"): ?>
                        <embed src="<?php echo $path; ?>#toolbar=0&navpanes=0&scrollbar=0" width="100%" height="500">
                            <?php else: ?>
                                <img src="<?php echo base_url("pengunjung/referensi/".$referensi['cover']) ?>" alt="<?php echo $referensi['cover']; ?>" class="img-responsive">
                            <?php endif ?>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6">
                        <div class="box wow">
                            ...
                            <p class="description" style="margin-left: 0;"><?php echo strip_tags($referensi['deskripsi']); ?></p>
                            <br/>
