...
<head>
    ...
    <meta name="description" content="<?php echo substr(strip_tags($service['isi_service']), 0,145) ?>">
    <meta name="author" content="">
    <title><?php echo $service["nama_service"] ?></title>
    <!-- Bootstrap Core CSS -->
...
<section class="detail">
        <div class="judul" style="background-image: url('<?php echo base_url("assets/service/".$service["gambar_service"]) ?>');">
            <div class="container">
                <div class="row">
                    <div class="col-md-8 col-md-offset-2 text-center">
                        <h1 class="wow fadeInDown"><?php echo $service["nama_service"] ?></h1>
                    </div>
                </div>
            </div>
        </div>
