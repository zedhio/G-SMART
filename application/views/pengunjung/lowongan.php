        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2 text-center">
                    <?php echo ambil_isi_pengaturan("career_header") ?>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 wow fadeInLeft">
                    <?php echo ambil_isi_pengaturan("career_konten") ?>
                ...
                <div class="col-lg-6 wow fadeInRight">
                    ...
                    <div class="row itemcareer">
                        <div class="col-md-4">
                            <div class="image">
                                <img src="<?php echo base_url("assets/lowongan/".$value['crop_lowongan']) ?>" alt="<?php echo $value['judul_lowongan'] ?>" class="img-responsive">
                            </div>
                        </div>
                        <div class="col-md-8">
                            <h3>
                                <a href="<?php echo base_url("career/detail/".$value["url_lowongan"]) ?>">
                                    <?php echo $value["judul_lowongan"] ?>
                                </a>
                            </h3>
                            <span>Expired <?php echo tanggal_indo($value['habis_lowongan']) ?></span>
                             <a href="<?php echo base_url("career/detail/".$value["url_lowongan"]) ?>">Selengkapnya <i class="fa fa-long-arrow-right"></i></a>
