    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 text-center">
                <?php echo ambil_isi_pengaturan("home_soal") ?>
            </div>
        </div>
    </div>
    <div class="container">
                ...
                <div class="col-md-6 wow">
                    <div class="post">
                        <div class="post-image">
                            <img src="<?php echo base_url("pengunjung/soal/".$value["cover"]) ?>" alt="<?php echo $value["judul"] ?>">
                        </div>
                        <div class="post-info">
                            <h2>
                                <a href="<?php echo base_url("soal/detail/".$value["id_soal"]) ?>">
                            ...
                            <a href="<?php echo base_url("soal/detail/".$value["id_soal"]) ?>">Selengkapnya <i class="fa fa-long-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
                <?php if (($key+1)%100==0): ?>
