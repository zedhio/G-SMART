        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2 text-center">
                    <?php echo ambil_isi_pengaturan("produk_header") ?>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="featured-product">
                <div class="row">
                    <div class="col-md-8 wow fadeInLeft">
                        <div class="image">
                            <img src="<?php echo base_url("assets/produk/".$pertama['gambar_produk']) ?>" alt="<?php echo $pertama["nama_produk"] ?>" class="img-responsive">
                        </div>
                    </div>
                    <div class="col-md-4 wow fadeInRight">
                        <h3>
                            <a href="<?php echo base_url("product/detail/".$pertama["url_produk"]) ?>">
                                <?php echo $pertama['nama_produk'] ?>
                            </a>
                        </h3>
                        <p><?php echo substr(strip_tags($pertama['isi_produk']), 0,300) ?>..</p>
                        <a href="<?php echo base_url("product/detail/".$pertama["url_produk"]) ?>">Selengkapnya <i class="fa fa-long-arrow-right"></i></a>
                    </div>
                </div>
            </div>
            <div class="quotes">
                <blockquote>
                    <?php echo ambil_isi_pengaturan("produk_quotes") ?>
                </blockquote>
            </div>
            <div class="row">
                <?php foreach ($produk as $key => $value): ?>

                <div class="col-md-4 itemproduk wow fadeInUp">
                    <div class="image">
                        <img src="<?php echo base_url("assets/produk/".$value["crop_produk"]) ?>" alt="<?php echo $value['nama_produk'] ?>" class="img-responsive">
                    </div>
                    <span><?php echo $value['nama_kategoriproduk'] ?></span>
                    <h3>
                        <a href="<?php echo base_url("product/detail/".$value["url_produk"]) ?>">
                            <?php echo $value['nama_produk'] ?>
                        </a>
                    </h3>
                    <p><?php echo substr(strip_tags($pertama['isi_produk']), 0,100) ?>..</p>
                </div>
