                ...
                <div class="col-md-6 wow">
                    <div class="post">
                        <div class="post-image">
                            <img src="<?php echo base_url("pengunjung/referensi/".$value["cover"]) ?>" alt="<?php echo $value["judul"] ?>">
                        </div>
                        <div class="post-info">
                            <h2>
                                <a href="<?php echo base_url("referensi/detail/".$value["id_referensi"]) ?>">
                            ...
                            <a href="<?php echo base_url("referensi/detail/".$value["id_referensi"]) ?>">Selengkapnya <i class="fa fa-long-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
                <?php if (($key+1)%100==0): ?>
