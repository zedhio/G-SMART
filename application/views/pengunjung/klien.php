		...
		<div class="container">
			<div class="row">
				<div class="col-lg-8 col-lg-offset-2 text-center">
					<?php echo ambil_isi_pengaturan("klien_header") ?>
				</div>
			</div>
		</div>
	</section>
			...
			<div class="row">
				<div class="col-md-8 col-md-offset-2">
					...
					<div class="groupclient">
						<div class="subtitle">
							<h3><?php echo $value["nama_kategoriklien"] ?></h3>
						</div>
						<div class="row">
							<?php foreach ($value['klien'] as $key => $pk): ?>
								
							<div class="col-md-3 text-center">
								<div class="image">
									<img src="<?php echo base_url("assets/klien/".$pk["gambar_klien"]) ?>" alt="<?php echo $pk['nama_klien'] ?>" class="img-responsive">
								</div>
								<span><?php echo $pk['nama_klien'] ?></span>
							</div>
							<?php endforeach ?>
						</div>
					</div>
