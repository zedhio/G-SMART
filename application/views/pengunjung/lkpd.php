               ...
               <div class="col-md-6 wow">
                <div class="post">
                    <div class="post-image">
                        <img src="<?php echo base_url("pengunjung/lkpd/".$value["cover"]) ?>" alt="<?php echo $value["judul"] ?>">
                    </div>
                    <div class="post-info">
                        <h2>
                            <a href="<?php echo base_url("lkpd/detail/".$value["id_lkpd"]) ?>">
                        ...
                        <a href="<?php echo base_url("lkpd/detail/".$value["id_lkpd"]) ?>">Selengkapnya <i class="fa fa-long-arrow-right"></i></a>
                    </div>
                </div>
            </div>
            <?php if (($key+1)%100==0): ?>
