...
<head>
    ...
    <meta name="description" content="<?php echo substr(strip_tags($detailnews['isi_news']), 0,145) ?>">
    <meta name="author" content="">
    <title><?php echo $detailnews["judul_news"] ?></title>
    <!-- Bootstrap Core CSS -->
...
<body id="page-top">
    ...
    <section class="detail">
        <div class="judul" style="background-image: url('<?php echo base_url("assets/news/".$detailnews["gambar_news"]) ?>');">
            <div class="container">
                <div class="row">
                    <div class="col-md-8 col-md-offset-2 text-center">
                        <h1 class="wow fadeInDown"><?php echo $detailnews["judul_news"] ?></h1>
                    </div>
                </div>
            </div>
        </div>
