...
<body id="page-top">
    ...
    <section class="hero" style="background-image:url('<?php echo ambil_isi_pengaturan("gambar_hero") ?>'); ">
        <div class="container">
            ...
            <div class="heroslider owl-theme owl-carousel" style="margin-top: 100px;">
                
                <?php foreach ($flash as $key => $value): ?>
                    
                <div class="row">
                    <div class="col-md-5">
                        <img src="<?php echo base_url("assets/news/".$value['crop_news']) ?>" alt="<?php echo $value["judul_news"] ?>" class="img-responsive">
                    </div>
                    <div class="col-md-7">
                        ...
                        <span>Published on <?php echo tanggal_indo($value['tanggal_news']) ?></span>
                    </div>
                </div>
                <?php endforeach ?>
