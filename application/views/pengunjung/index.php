...
<body id="page-top">
    ...
    <section class="topbar" style="background-image:url('<?php echo ambil_isi_pengaturan("gambar_hero") ?>');background-position: center;background-size: cover;">
        <div class="container">
            <div class="row">
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 text-center">
                <?php echo ambil_isi_pengaturan("home") ?>
            </div>
        </div>
    </div>
    <div class="container">
        <div class="row">
            <a href="<?php echo base_url("buku"); ?>">
                <div class="col-lg-6">
                    <div class="box wow fadeInRight">
                        <div class="icon">
                            <img src="<?php echo base_url("assets/komponen/book.png"); ?>" alt="" width="60">
                        </div>
                        <h4 class="title" style="color:#333;">
                            Buku Teks Sekolah
                        </h4>
            ...
            <a href="<?php echo base_url("rpp"); ?>">
                <div class="col-lg-6">
                    <div class="box wow fadeInLeft">
                        <div class="icon">
                            <img src="<?php echo base_url("assets/komponen/test.png"); ?>" alt="" width="60">
                        </div>
                        <h4 class="title" style="color:#333;">
                            RPP
                        </h4>
            ...
            <a href="<?php echo base_url("lkpd"); ?>">
                <div class="col-lg-6">
                    <div class="box wow fadeInRight">
                        <div class="icon">
                            <img src="<?php echo base_url("assets/komponen/evaluation.png"); ?>" alt="" width="60">
                        </div>
                        <h4 class="title" style="color:#333;">
                            LKPD
                        </h4>
            ...
            <a href="<?php echo base_url("multimedia"); ?>">
                <div class="col-lg-6">
                    <div class="box wow fadeInLeft">
                        <div class="icon">
                            <img src="<?php echo base_url("assets/komponen/play-button.png") ?>" alt="" width="60">
                        </div>
                        <h4 class="title" style="color:#333;">
                            Multimedia
                        </h4>
            ...
            <a href="<?php echo base_url("referensi"); ?>">
                <div class="col-lg-6">
                    <div class="box wow fadeInLeft">
                        <div class="icon">
                            <img src="<?php echo base_url("assets/komponen/scholarship.png") ?>" alt="" width="60">
                        </div>
                        <h4 class="title" style="color:#333;">
                            Referensi Umum
                        </h4>
            ...
            <a href="<?php echo base_url("soal"); ?>">
                <div class="col-lg-6">
                    <div class="box wow fadeInRight">
                        <div class="icon">
                            <img src="<?php echo base_url("assets/komponen/library.png") ?>" alt="" width="60">
                        </div>
                        <h4 class="title" style="color:#333;">
                            Bank Soal
                        </h4>
...
if($check==1)
{
    ...
    swal({
        ...
        {
            echo '<script src="https://unpkg.com/sweetalert/dist/sweetalert.min.js"></script>';
            echo '<script>swal("Gagal!", "Password Salah!", "warning");</script>';
        }
        ?>
    </body>
    </html>
