...
<head>
    ...
    <meta name="description" content="<?php echo substr(strip_tags($jenis['deskripsi_jenisservice']), 0,145) ?>">
    <meta name="author" content="">
    <title><?php echo $jenis["nama_jenisservice"] ?></title>
    <!-- Bootstrap Core CSS -->
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2 text-center">
                    <h1><?php echo $jenis["nama_jenisservice"]; ?></h1>
                    <p><?php echo $jenis['deskripsi_jenisservice']; ?></p>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-4 wow fadeInDown">
                    <div class="image">
                        <img src="<?php echo base_url("assets/service/".$value["gambar_service"]) ?>" alt="" class="img-responsive">
                    </div>
                    <h3>
                        <a href="<?php echo base_url("service/".$jenis["url_jenisservice"]."/".$value["url_service"]) ?>">
                        	<?php echo $value["nama_service"] ?>
                        </a>
                    </h3>
                </div>
