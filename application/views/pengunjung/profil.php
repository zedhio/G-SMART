...
<head>
    ...
    <meta name="description" content="<?php echo substr(strip_tags($detailprofil['isi_profil']), 0,145) ?>">
    <meta name="author" content="">
    <title><?php echo $detailprofil["nama_profil"] ?></title>
    <!-- Bootstrap Core CSS -->
...
<body id="page-top">
    ...
    <section class="detail">
        <div class="judul" style="background-image: url('<?php echo base_url("assets/profil/".$detailprofil["gambar_profil"]) ?>');">
            <div class="container">
                <div class="row">
                    <div class="col-md-8 col-md-offset-2 text-center">
                        <h1 class="wow fadeInDown"><?php echo $detailprofil["nama_profil"] ?></h1>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-8 col-md-offset-2 wow fadeInUp">
                        <?php echo $detailprofil['isi_profil'] ?>
                    </div>
                </div>
